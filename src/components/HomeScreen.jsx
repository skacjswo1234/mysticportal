    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center p-6 text-center fade-in">
            <div className="mb-10">
                ...
                <p className="text-sm text-pink-200 eng-font mt-2 tracking-widest">MAGICAL DESTINY LAB</p>
            </div>
            ...
            <div className="w-full max-w-xs">
                <button onClick={() => onSelect('DESTINY')} className="btn-portal btn-destiny">
                    ...
                    <div className="text-left">
                        <div className="text-lg font-cute">운명 코드</div>
                        <div className="text-xs opacity-80 font-eng">Numerology Tarot</div>
                    </div>
                </button>
                <button onClick={() => onSelect('MIND')} className="btn-portal btn-mind">
                    <div className="bg-white/20 p-2 rounded-full"><IconBrain /></div>
                    <div className="text-left">
                        <div className="text-lg font-cute">직관 심리</div>
                        <div className="text-xs opacity-80 font-eng">Future Pattern</div>
                    </div>
                </button>
                <button onClick={() => onSelect('COLOR')} className="btn-portal btn-color" style={{background: 'linear-gradient(135deg, #059669, #34d399)'}}>
                    ...
                    <div className="text-left">
                        <div className="text-lg font-cute">색채 오라</div>
                        <div className="text-xs opacity-80 font-eng">Color Energy</div>
                    </div>
                </button>
                <button onClick={() => onSelect('POTION')} className="btn-portal btn-potion" style={{background: 'linear-gradient(135deg, #3b82f6, #0ea5e9)'}}>
                    ...
                    <div className="text-left">
                        <div className="text-lg font-cute">미래 연금술</div>
                        <div className="text-xs opacity-80 font-eng">Alchemy Lab</div>
                    </div>
                </button>
                <button onClick={() => onSelect('TAROT')} className="btn-portal btn-tarot">
                    <div className="bg-white/20 p-2 rounded-full"><IconTarot /></div>
                    <div className="text-left">
                        <div className="text-lg font-cute">타로 스프레드</div>
                        <div className="text-xs opacity-80 font-eng">3-Card Reading</div>
                    </div>
                </button>
            </div>
        </div>
